export default function Home() {
  return (
    <main className="flex  flex-col ">
      ...
      <article className="flx flex-col p-6 gap-20 leading-9  mx-auto w-fit">
        <h2 className="text-4xl mb-4  text-indigo-400">Itai Mizlish</h2>
        <h1 className="text-5xl mb-4">Frontend Developer</h1>
        <h3 className="text-2xl  mb-8 text-indigo-400">
          Always focused on UX, optimization and sharing great solutions to
          other developers.
        </h3>
        <p className="text-xl tracking-wide ">
          👨‍💻 Open Source Contributor 🏃  Qwikifier 🧳 Traveler 👨‍⚕️ ❔  Whovian 👨‍🍳
          Junior Cook 🥧 quiche Lover
        </p>
      </article>
    </main>
  );
